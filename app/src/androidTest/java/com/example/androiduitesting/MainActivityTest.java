...
public class MainActivityTest {
    ...
    public void testActivitySwitch() {
        ...
        Intents.init();
        Espresso.onData(anything()).inAdapterView(withId(R.id.city_list)).atPosition(0).perform(click());
    ...
    public void testBackButton() {
        ...
        Espresso.onData(anything()).inAdapterView(withId(R.id.city_list))
                .atPosition(0).perform(click());

        Espresso.onView(withId(R.id.button_back)).perform(click());

        Espresso.onView(withId(R.id.city_list)).check(ViewAssertions.matches(isDisplayed()));
    }
